 ...
 * 
 * Regras:
 * - Se forcePromoPrices=true => true (ignora TTL)
 ...
 * @param forcePromoPrices Se true, ignora TTL e força busca (default: false)
...
export function shouldFetchMlPricesForPromo(
  ...
  // Se forcePromoPrices=true, ignorar TTL e sempre buscar
  if (forcePromoPrices) {
    return true;
  }
