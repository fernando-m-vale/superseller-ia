...
async function main() {
  console.log('--- [DEBUG] Server Starting - Rota Final Fix ---');

  // CORREÇÃO CRÍTICA: Adicionada a barra inicial '/' em todos os prefixos
  ...
  try {
    await app.ready(); // Garante que todos os plugins de rota sejam carregados antes de escutar
